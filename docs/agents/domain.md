...
Use `docs/README.md` to find stable specifications and source research. Open choices and work progress belong in GitHub Issues as defined in `issue-tracker.md`; record an accepted architectural outcome in an ADR only when its enduring decision value warrants one.
